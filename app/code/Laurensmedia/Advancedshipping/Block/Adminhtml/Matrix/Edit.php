...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('matrix')->getId()) {
            return __("Edit Matrix '%1'", $this->escapeHtml($this->_coreRegistry->registry('matrix')->getTitle()));
        } else {
            return __('New Matrix');
        }
    }
    ...
    {
        return $this->getUrl('advancedshipping/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
