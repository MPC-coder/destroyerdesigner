...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('matrix');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Laurensmedia\Advancedshipping\Model\Matrix')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('advancedshipping/*/index');
    }
