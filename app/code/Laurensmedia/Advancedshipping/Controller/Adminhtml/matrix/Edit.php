...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Laurensmedia_Advancedshipping::Matrix')
            ->addBreadcrumb(__('Laurensmedia Advancedshipping'), __('Laurensmedia Advancedshipping'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('matrix', $model);
