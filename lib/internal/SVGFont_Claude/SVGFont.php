...
protected static $fontSynonyms = [
    ...
    'verdana' => 'Verdana',
    'viksi script' => 'Viksi Script',

    // génériques
    'sans-serif' => 'Arial',
    'serif' => 'Libre Baskerville',
    'cursive' => 'Script MT Bold',
    'fantasy' => 'Old English Text MT',
    'monospace' => 'Ubuntu',
...
function utf8ToUnicode(?string $str): array
{
    ...
    function textToPaths($text, $asize) {
        error_log("textToPaths reçoit: '$text'");
    error_log("Caractères: " . implode(", ", array_map('ord', str_split($text))));
